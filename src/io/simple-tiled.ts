...
export class SimpleTilesetParser {
  static async load(xml: string, tilesDir: string): Promise<Tileset> {
    ...
    for (const neigh of neighbors) {
      ...
      const rightstr = neigh.getAttribute("left")!;
    ...
    return new Tileset(tileSize, tiles, frequencies, allowed);
  }
}
